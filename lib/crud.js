...
class CrudDB {
  ...
  viewDepartments() {
    console.log("department query here")
    return "department names and department id's"
  };
  viewRoles() {
    console.log("role query here")
    return "job title, role id, department the role belongs to, salary for the role"
  };
  viewEmployees() {
    console.log("employee query here")
    return "employee id, first name, last name, job titles, department, salaries, managers"
  };
  addDepartment() {
    inquirer
      .prompt([
